    ...
    <Navbar active-page="download">
        <template #content>
            ...
            <div class="container mx-auto px-4 sm:px-16 -mt-36">
                <h1 class="text-custome-orange text-3xl font-semibold">Keloola OS 1.0</h1>
            </div>
            <div class="bg-gradient-to-r from-[#413E1E] via-custome-gray via-40% to-custome-gray mt-3 py-12 text-white">
                <h2 class="font-medium text-center">Are You Prepared to Install?</h2>
                <p class="text-center text-white text-sm leading-loose my-2">Keloola OS is available in various editions tailored to meet diverse needs. Please select your preferred version below.<br>
                    For detailed guidance on the installation process, consult the provided instructions.
                </p>
            ...
            <div class="bg-black text-white">
                <div class="bg-contain bg-left-top bg-no-repeat h-72 pt-10 z-0" style="background-image: url(/assets/wave-03\ 6.svg)"></div>
                <div class="container mx-auto px-4 sm:px-16 -mt-60 pb-28 z-10">
                    <div class="mt-12 md:flex items-center gap-12">
                        ...
                        <div class="w-full mt-6 md:mt-0 md:w-1/2">
                            <p class="italic text-sm">Stability in Simplicity</p>
                            <p class="text-2xl my-2 font-bold">Tambora Edition</p>
                            <p class="text-sm mb-2 leading-loose">Tambora is the most streamlined and efficient version available. With its<br class="hidden lg:flex">
                                beautiful, intuitive interface, it sets a new standard for simplicity and<br class="hidden lg:flex">
                ...
                <div class="bg-cover bg-center h-72 z-0 flex justify-center items-center -mt-72" style="background-image: url(/assets/wave-03\ 5.svg)"></div>
            </div>
            <!-- End Content -->
        </template>
    </Navbar>
